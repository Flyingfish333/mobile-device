package com.example.com6510_assignment.viewmodel
...
import com.example.com6510_assignment.repository.asDomainModel
import com.example.com6510_assignment.repository.asDomainModels
...
class ImageViewModel(private val repository: ImageRepository, private val applicationContext: Application) : AndroidViewModel(applicationContext) {
    ...
    fun insert(
        image_uri: Uri,
        title: String = R.string.default_image_title.toString(),
